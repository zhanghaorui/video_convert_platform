package com.fab.video_convert_platform.infra.monitor;
...
public class VideoProcessingMonitorAspect {
     ...
     * 监控视频上传操作
     */
    @Around("execution(* com.fab.video_convert_platform.service.IVideoService.upload(..))")
     ...
     * 监控分片上传操作
     */
    @Around("execution(* com.fab.video_convert_platform.service.IVideoService.uploadChunk(..))")
     ...
     * 监控视频处理流程
     */
    @Around("execution(* com.fab.video_convert_platform.domain.service.VideoTaskDomainService.processSlices(..))")
     ...
     * 监控FFmpeg操作
     */
    @Around("execution(* com.fab.video_convert_platform.util.FFmpegUtil.*(..))")
